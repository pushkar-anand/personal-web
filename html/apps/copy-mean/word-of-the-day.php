...
if (!entry_exists($todays_date)) {
    ...
    $definationXPath = "/html/body/div[1]/div/div[4]/main/article/div[3]/div[1]/div/div[1]/node()";
    ...
    $stmt->bind_result($word, $meanJSON, $example);
    $stmt->fetch();

    $arr = json_decode($meanJSON, true);
    $meanArr = $arr["meaning"];
}
