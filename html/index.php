...
<head>
    ...
    <meta name="description"
          content="A programmer trying to create a mark on the world. Currently pursuing his engineering in computer science he wishes to do something exciting in his life ">
    ...
    <link rel="stylesheet" type="text/css"
          href="css/loadcss?css=owl.transitions.css/w3.css/main.css/responsive.css/font-awesome.min.css/animate.css/lightbox.css/owl.carousel.css/owl.theme.default.css/emoji.css"/>
    <?php
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner text-center">
                    ...
                    <h2 class="wow fadeInDown animated" data-wow-delay=".6s">The geek who loves to code<i
                                class="em em-heart "></i></h2>
                    <h4 class="wow fadeInDown animated" data-wow-delay=".4s"></h4>
                    <a href="#feedback" class="btn btn-border lg wow fadeInLeft animated" data-wow-delay="1.0s">Contact
                        Me</a>
                    <a href="#works" class="btn btn-common lg wow fadeInRight animated" data-wow-delay="1.0s">Learn
                        More</a>
                    <div class="scroll">
                        <a href="#works"><i class="fa fa-angle-down wow fadeInUp animated"
...
<section id="skills">
    <div class="container">
        <div class="row">
            <h1 class="section-title wow fadeInLeft animated" data-wow-delay=".4s">My<br>Passionate<br>
                <span>Skills</span>
            </h1>
...
<section id="feedback">
    <div class="container">
        <div class="row">
            <h1 class="section-title wow fadeInLeft animated" data-wow-delay=".6s"><span>Hire</span><br>or Contact <br>
                Me</h1>
            <div class="col-sm-6 col-md-6 wow fadeInLeft animated" data-wow-delay="1.4s">
                <form action="contact" name="contact" method="post">
                    ...
                    <button type="submit" class="btn btn-green" name="send"><i class="fa fa-envelope-o"></i>Send
                    </button>
                </form>
            </div>
            <div class="col-sm-4 col-md-4 col-md-offset-2 wow fadeInRight animated" data-wow-delay="1.4s">
                <div class="address">
                    ...
                    <ul class="social-icon">
                        <li><a href="https://www.facebook.com/anandpushkar088" target="_blank" rel="noopener"><i
                                        class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/Pushkar_Anand_0" target="_blank" rel="noopener"><i
                                        class="fa fa-twitter"></i></a></li>
                        <li><a href="https://www.linkedin.com/in/anandpushkar088" target="_blank" rel="noopener"><i
                                        class="fa fa-linkedin"></i></a></li>
                        <li><a href="https://plus.google.com/+PushkarAnand_me" target="_blank" rel="noopener"><i
                                        class="fa fa-google-plus"></i></a></li>
                        <li><a href="https://github.com/pushkar-anand" target="_blank" rel="noopener"><i
                                        class="fa fa-github"></i></a></li>
                        <li><a href="https://stackoverflow.com/users/4257791/pushkar" target="_blank" rel="noopener"><i
                                        class="fa fa-stack-overflow"></i></a></li>
                        <li><a href="https://www.instagram.com/pushkar.anand/" target="_blank" rel="noopener"><i
...
<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                <p class="text-center wow fadeInUp animated" data-wow-delay=".8s">Developed By <a
